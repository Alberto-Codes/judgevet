...
```bash
python -m pip install 'judgevet[mcp]==0.13.0'
```
...
<!-- x-release-please-start-version -->
```bash
uv tool install 'judgevet[mcp]==0.13.0'
```
<!-- x-release-please-end -->
...
<!-- x-release-please-start-version -->
```bash
uvx --from 'judgevet[mcp]==0.13.0' judgevet-mcp
```
<!-- x-release-please-end -->
...
```json
{
  "servers": {
    "judgevet": {
      "type": "stdio",
      "command": "uvx",
      "args": ["--from", "judgevet[mcp]==0.13.0", "judgevet-mcp"],
...
<!-- x-release-please-start-version -->
```bash
claude mcp add --transport stdio --scope project judgevet --env 'JEV_API__KEY=${JEV_API__KEY}' -- uvx --from 'judgevet[mcp]==0.13.0' judgevet-mcp
```
<!-- x-release-please-end -->
...
<!-- x-release-please-start-version -->
```bash
uvx --from 'judgevet==0.13.0' judgevet 'Two checks passed.' '{"noul_question":{"type":"noul","instructions":"Did the checks pass?"}}' --json
```
<!-- x-release-please-end -->

<!-- x-release-please-start-version -->
```bash
uvx --from 'judgevet==0.13.0' judgevet 'Two checks passed.' '{"choice_question":{"type":"choice","instructions":"Did the checks pass?","criteria":{"yes":"Yes","no":"No"}}}' --json
```
<!-- x-release-please-end -->

<!-- x-release-please-start-version -->
```bash
uvx --from 'judgevet==0.13.0' judgevet 'Two checks passed.' '{"score_question":{"type":"score","instructions":"Did the checks pass?","criteria":["Poor","Fair","Good","Excellent"]}}' --json
```
<!-- x-release-please-end -->
...
<!-- x-release-please-start-version -->
```bash
direnv exec /absolute/path/to/project uvx --from 'judgevet[mcp]==0.13.0' judgevet-mcp
```
<!-- x-release-please-end -->
